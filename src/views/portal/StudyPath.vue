            ...
            <div v-if="selectedPath" class="path-detail-dialog">
                ...
                <div class="path-steps">
                    ...
                    <el-steps :active="selectedPath.currentStep" direction="vertical">
                        <el-step
                            v-for="(step, index) in selectedPath.stepList"
                            :key="index"
...
const frontendPaths = reactive([
    {
        ...
        currentStep: 0,
        stepList: [
            { title: 'Vue.js 基础入门', description: '掌握Vue.js核心概念和基础语法', completed: false },
            { title: '组件化开发', description: '学习Vue组件化开发思想', completed: false },
            { title: '路由与状态管理', description: '掌握Vue Router和Vuex', completed: false },
            { title: '项目实战', description: '企业级项目开发实践', completed: false },
            { title: '性能优化', description: 'Vue.js性能优化技巧', completed: false },
            { title: '部署上线', description: '项目部署和运维', completed: false },
        ],
        courseList: [
            { id: 1, title: 'Vue.js 基础教程', description: '零基础入门Vue.js', duration: '10小时', level: '初级', cover: logo },
            { id: 2, title: 'Vue.js 组件开发', description: '组件化开发实战', duration: '15小时', level: '中级', cover: logo },
            { id: 3, title: 'Vue.js 项目实战', description: '企业级项目开发', duration: '20小时', level: '高级', cover: logo },
        ],
    },
    {
        id: 2,
        ...
        currentStep: 0,
        stepList: [
            { title: 'React 基础', description: '掌握React核心概念', completed: false },
            ...
            { title: '状态管理', description: 'Redux和Context API', completed: false },
            { title: '项目实战', description: 'React项目开发', completed: false },
        ],
        courseList: [
            { id: 4, title: 'React 基础入门', description: 'React核心概念', duration: '12小时', level: '初级', cover: logo },
            { id: 5, title: 'React Hooks', description: 'Hooks深度解析', duration: '8小时', level: '中级', cover: logo },
            { id: 6, title: 'React 项目实战', description: '企业级应用开发', duration: '25小时', level: '高级', cover: logo },
        ],
    },
])
...
const backendPaths = reactive([
    {
        ...
        stepList: [
            ...
            { title: 'Spring Boot', description: 'Spring Boot开发', completed: false },
            { title: '数据库操作', description: 'MyBatis和JPA', completed: false },
            { title: '项目实战', description: '企业级项目开发', completed: false },
        ],
        courseList: [
            { id: 7, title: 'Java基础教程', description: 'Java语言入门', duration: '20小时', level: '初级', cover: logo },
            { id: 8, title: 'Spring Boot实战', description: 'Spring Boot开发', duration: '30小时', level: '中级', cover: logo },
            { id: 9, title: 'Java项目实战', description: '企业级应用开发', duration: '40小时', level: '高级', cover: logo },
        ],
    },
])
...
const mobilePaths = reactive([
    {
        ...
        currentStep: 0,
        stepList: [
            { title: 'Flutter基础', description: 'Flutter开发环境搭建', completed: false },
            { title: 'UI开发', description: 'Flutter UI组件使用', completed: false },
            { title: '状态管理', description: 'Flutter状态管理方案', completed: false },
            { title: '项目实战', description: 'Flutter应用开发', completed: false },
        ],
        courseList: [
            { id: 10, title: 'Flutter入门', description: 'Flutter基础教程', duration: '15小时', level: '初级', cover: logo },
            { id: 11, title: 'Flutter UI开发', description: 'UI组件深度解析', duration: '20小时', level: '中级', cover: logo },
            { id: 12, title: 'Flutter项目实战', description: '跨平台应用开发', duration: '35小时', level: '高级', cover: logo },
        ],
    },
])
