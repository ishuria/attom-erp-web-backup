<template>
  <vab-dialog v-model="dflag" title="添加耗材" top="5%" width="55%" @close="handlerCloseDialog">
    <vab-query-form>
  ...
  <!-- 创建耗材组件 -->
  <vab-create-consumable v-model="createVisible" :consumable-types="consumableTypes" @submit="handleCreateSubmit" />
</template>
