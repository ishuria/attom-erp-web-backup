  ...
  <vab-dialog v-model="visible" class="custom-dialog" :draggable="false" title="新品质检报告" top="3vh" width="50%" @close="closeQualityInspection">
    ...
    >
      ...
      <el-form-item label="备注" prop="remark" >
        ...
        <el-input v-model="inspectionResultsForm.remark" disabled placeholder="请输入备注" resize="none" :rows="2" type="textarea"/>
      </el-form-item>
      <el-form-item label="质检打包数" prop="packageCount" >
        <el-input v-model.trim="inspectionResultsForm.packageCount" clearable disabled placeholder="产品经理打包套数" style="min-width: 100%"/>
      </el-form-item>
      <el-form-item label="结论" prop="status" >
        <el-radio-group v-model="inspectionResultsForm.status" disabled>
      ...
      <el-form-item v-if="inspectionResultsForm.status" label="原因" prop="reason"  >
        <el-input v-model="inspectionResultsForm.reason"  clearable disabled placeholder="质检不通过的原因" style="min-width: 100%"/>
      </el-form-item>
      <el-form-item v-if="inspectionResultsForm.status" label="处理方式" prop="processingMethod" >
        <el-input v-model="inspectionResultsForm.processingMethod" clearable disabled placeholder="整批售后、打包全检、部分售后等"  style="min-width: 100%"/>
      </el-form-item>
    </el-form>
...
const inspectionResultsForm = reactive<any>({})
