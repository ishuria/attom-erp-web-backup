<template>
  <div class="comprehensive-table-container auto-height-container">
    ...
    />
    <!-- 新增合并分类 -->
    <vab-dialog v-model="addClassVisible" title="新增合并分类" width="75%">
      ...
      <div style="margin-top: 20px; text-align: center">
        ...
        <div class="transfer-container">
          <el-transfer v-model="transferValue" :data="addList" filterable :titles="['源列', '目的列']">
    ...
    <!-- 添加SKU -->
    <vab-dialog v-model="addVisible" title="添加SKU" width="75%">
      <div style="text-align: center">
        <div style="margin-bottom: 20px; font-size: medium">选择合并计算工时的SKU</div>
        <div class="transfer-container">
          <el-transfer v-model="transferValue" :data="addList" filterable :titles="['源列', '目的列']">
