                            ...
                            <div class="control-group">
                                ...
                                <div class="preset-section">
                                    <div class="preset-buttons">
                                        <el-button
                                            :type="isPresetActive('standard') ? 'primary' : 'default'"
                                            @click="setPreset('standard')"
                                        >
                                            标准模式
                                        </el-button>
                                        <el-button
                                            :type="isPresetActive('external') ? 'primary' : 'default'"
                                            @click="setPreset('external')"
                                        >
                                            外部放大
                                        </el-button>
                                        <el-button :type="isPresetActive('taobao') ? 'primary' : 'default'" @click="setPreset('taobao')">
                                            淘宝模式
                                        </el-button>
                                    </div>
                                </div>
