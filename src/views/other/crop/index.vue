...
// mock线上环境下不支持http链接，如需使用http链接请在线上移除mock
// const landscape = ref<string>(`https://res.hc-cdn.com/tiny-vue-web-doc/3.10.5.20230903162611/static/images/mountain.png`)
