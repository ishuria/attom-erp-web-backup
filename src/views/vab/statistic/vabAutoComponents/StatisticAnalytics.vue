                    ...
                    <el-row :gutter="20">
                        <el-col :lg="6" :md="12" :sm="24" :xl="6" :xs="24">
                            <div class="analytics-card">
                                ...
                                <div class="card-chart">
                                    <el-progress
                                        :color="conversionColors"
                                        :percentage="analyticsData.conversionRate"
                                        type="circle"
                                        :width="60"
                                    />
                                </div>
                        ...
                        <el-col :lg="6" :md="12" :sm="24" :xl="6" :xs="24">
                            <div class="analytics-card">
                                ...
                                <div class="card-chart">
                                    <el-progress
                                        :color="repurchaseColors"
                                        :percentage="analyticsData.repurchaseRate"
                                        type="circle"
                                        :width="60"
                                    />
                                </div>
                        ...
                        <div class="channel-list">
                            <div v-for="channel in channelData" :key="channel.name" class="channel-item">
                                ...
                                <div class="channel-trend">
                                    <el-progress
                                        :color="getChannelColor(channel.performance)"
                            ...
                            <div class="prediction-card">
                                ...
                                <div class="prediction-content">
                                    ...
                                    <div class="prediction-confidence">
                                        ...
                                        <el-progress
                                            color="#f56c6c"
                                            :percentage="predictionData.stockUrgency"
                                            :show-text="false"
                                            :stroke-width="4"
                                        />
                                    </div>
