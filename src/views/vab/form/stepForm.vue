                        ...
                        <vab-card class="form-card">
                            ...
                            <div class="form-actions">
                                ...
                                <div class="action-center">
                                    <el-button v-if="active < 2" :icon="ArrowRight" :loading="loading" type="primary" @click="handleNext">
                                        下一步
                                    </el-button>
                                    <el-button v-if="active === 2" :icon="Check" :loading="loading" type="success" @click="handleComplete">
                                        完成
                                    </el-button>
                                </div>
