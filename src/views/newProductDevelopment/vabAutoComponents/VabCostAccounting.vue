    ...
    >
      ...
      >
          ...
          <template #default="{ row }">
            ...
            <span
              :style="{
                ...
                'min-width': flexColumnWidth(estimatedCostList, '产品价格m', 'price', 0),
                'text-align': 'right',
              }"
            >
        ...
        <el-table-column label="长(cm)" width="80">
          <template #default="{ row }">
            ...
            <span
              :style="{
                display: 'inline-block',
                'min-width': flexColumnWidth(estimatedCostList, '长(cm', 'length', 0),
                'text-align': 'right',
              }"
            >
        ...
        <el-table-column label="宽(cm)" width="80">
          <template #default="{ row }">
            ...
            <span
              :style="{
                display: 'inline-block',
                'min-width': flexColumnWidth(estimatedCostList, '宽(cm', 'width', 0),
                'text-align': 'right',
              }"
            >
        ...
        <el-table-column label="高(cm)" width="80">
          <template #default="{ row }">
            ...
            <span
              :style="{
                display: 'inline-block',
                'min-width': flexColumnWidth(estimatedCostList, '高(cm', 'height', 0),
                'text-align': 'right',
              }"
            >
        ...
        <el-table-column label="重量(g)" width="80">
          <template #default="{ row }">
            ...
            <span
              :style="{
                display: 'inline-block',
                'min-width': flexColumnWidth(estimatedCostList, '重量(g', 'weight', 0),
                'text-align': 'right',
              }"
            >
        ...
        <el-table-column label="尾程" prop="lastMile" width="80">
          <template #default="{ row }">
            <span
              :style="{
                display: 'inline-block',
                'min-width': flexColumnWidth(estimatedCostList, '尾程', 'lastMile', 0),
                'text-align': 'right',
              }"
            >
        ...
        <el-table-column label="头程￥" prop="firstMile" width="80">
          <template #default="{ row }">
            <span
              :style="{
                display: 'inline-block',
                'min-width': flexColumnWidth(estimatedCostList, '头程', 'firstMile', 0),
                'text-align': 'right',
              }"
            >
        ...
        <el-table-column label="打包￥" width="80">
          <template #default="{ row }">
            ...
            <span
              :style="{
                display: 'inline-block',
                'min-width': flexColumnWidth(estimatedCostList, '打包', 'packaging', 0),
                'text-align': 'right',
              }"
            >
        ...
        <el-table-column label="售价" width="100">
          <template #default="{ row }">
            ...
            <span
              :style="{
                display: 'inline-block',
                'min-width': flexColumnWidth(estimatedCostList, '$售价', 'sellingPrice', 0),
                'text-align': 'right',
              }"
            >
        ...
        <el-table-column label="毛利率" prop="grossMarginRate" width="100">
          <template #default="{ row }">
            <span
              :style="{
                display: 'inline-block',
                'min-width': flexColumnWidth(estimatedCostList, '毛利m', 'grossMarginRate', 0),
                'text-align': 'right',
              }"
            >
        ...
        <el-table-column label="ROI" prop="roi" width="80">
          <template #default="{ row }">
            <span
              :style="{ display: 'inline-block', 'min-width': flexColumnWidth(estimatedCostList, 'ROI%', 'roi', 0), 'text-align': 'right' }"
            >
        ...
        <el-table-column label="重量系数" width="100">
          <template #default="{ row }">
            ...
            <span
              :style="{
                display: 'inline-block',
                'min-width': flexColumnWidth(estimatedCostList, '重量系6', 'weightCoefficient', 0),
                'text-align': 'right',
              }"
            >
        ...
        <el-table-column label="体积系数" width="100">
          <template #default="{ row }">
            ...
            <span
              :style="{
                display: 'inline-block',
                'min-width': flexColumnWidth(estimatedCostList, '体积系6', 'volumeCoefficient', 0),
                'text-align': 'right',
              }"
            >
        ...
        <el-table-column label="关税%" width="80">
          <template #default="{ row }">
            ...
            <span
              :style="{
                display: 'inline-block',
                'min-width': flexColumnWidth(estimatedCostList, '关税%', 'tariff', 0),
                'text-align': 'right',
              }"
            >
        ...
        <el-table-column label="关税" width="80">
          <template #default="{ row }">
            <span
              :style="{
                display: 'inline-block',
                'min-width': flexColumnWidth(estimatedCostList, '关税', 'tariffPrice', 0),
                'text-align': 'right',
              }"
            >
        ...
        <el-table-column label="平台佣金" prop="platformCommission" width="100">
          <template #default="{ row }">
            <span
              :style="{
                display: 'inline-block',
                'min-width': flexColumnWidth(estimatedCostList, '平台佣6', 'other', 0),
                'text-align': 'right',
              }"
            >
        ...
        <el-table-column label="仓储费2个月" min-width="140" prop="storageFee">
          <template #default="{ row }">
            <span
              :style="{
                display: 'inline-block',
                'min-width': flexColumnWidth(estimatedCostList, '仓储费个月', 'other', 0),
                'text-align': 'right',
              }"
            >
...
const clickCancel = async (event: any, value: IProgressEstimatedCostAccounting) => {
  ...
  await costAccountingUpdate({
    ...
    grossMarginRate: `${parseFloat(value.grossMarginRate!) / 100}`,
