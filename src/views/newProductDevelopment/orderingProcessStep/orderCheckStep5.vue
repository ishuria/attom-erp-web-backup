<template>
    <div>
        ...
        >
            ...
            <el-table-column label="状态" min-width="127" align="center">
      
            </el-table-column>
            <el-table-column label="开票类型" min-width="127" align="center">
      
            </el-table-column>
            <el-table-column label="付款金额" min-width="127" align="center">
      
            </el-table-column>
            <el-table-column label="处理方式" min-width="127" align="center">
      
            </el-table-column>
            <el-table-column label="均摊方式" min-width="127" align="center">
