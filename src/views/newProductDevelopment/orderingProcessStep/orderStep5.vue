...
const FIELD_INDEX_MAP = {
  ...
  PATENT_FLAG: 14,
  MOQ_IDX: 15,
  FULL_CASE_QTY_IDX: 16,
  BENCHMARK_ASIN: 17,
  PATENT: 18,
  PRODUCT_MANAGER: 19,
  PRODUCT_DESIGN: 20,
  PROCUREMENT_MANAGER: 21,
  SAMPLE_RETENTION: 22,
  APPROVAL_BUSINESS_ID: 23,
  PACKING_GROUP: 24,
  MANUFACTURER_EN_NAME: 25,
  CERTIFICATE_UPLOAD: 26,
  SKU_MERGE: 27,
  OPERATE: 28,
  ORDER_ENTRY_ID: 29,
  PRODUCT_MANAGER_ID: 30,
  PRODUCT_DESIGN_ID: 31,
  PROCUREMENT_MANAGER_ID: 32,
} as const
...
const buildParams = (key: string) => {
  const params = {
    ...
    brand: exchangeList.value[FIELD_INDEX_MAP.BRAND][key],
