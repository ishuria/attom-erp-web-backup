<template>
  <vab-dialog v-model="zflag" :before-close="handlerCloseDialog" title="成本核算默认参数" width="500">
    ...
    <template #footer>
      <div class="dialog-footer">
        <el-button type="primary" @click="commitUpdateCostParam">提交修改</el-button>
      </div>
    </template>
  </vab-dialog>
</template>
...
import type { ICostAccounting } from '/@/type/evaluation/evaluationType'

import { updateEvaluationCostParams } from '/@/api/devlocal/evaluation'
