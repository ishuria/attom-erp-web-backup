 ...
 * @returns
 */
export function getPurchaseStatisticsSupplierList(
  data: IGetPurchaseStatisticsSupplierListReq
): Promise<IGetPurchaseStatisticsSupplierListRes> {
  return request({
 ...
 * @returns
 */
export function getPurchaseStatisticsProductList(
  data: IGetPurchaseStatisticsSupplierListReq
 ...
 * @returns
 */
export function getPurchaseStatisticsProductDetailList(
  data: IGetPurchaseStatisticsProductDetailListReq
): Promise<IGetPurchaseStatisticsProductListRes> {
  return request({
